...
export default function AdminDashboard() {
    ...
    const fetchData = async () => {
        ...
        try {
            // Coaches
            const resCoaches = await fetch('/api/users/coaches', { headers: { Authorization: `Bearer ${token}` } });
            ...
            // Content
            const resContent = await fetch('/api/content', { headers: { Authorization: `Bearer ${token}` } });
    ...
    const handleCreateCoach = async (e) => {
        e.preventDefault();
        try {
            const res = await fetch('/api/users/create_coach', {
                method: 'POST',
